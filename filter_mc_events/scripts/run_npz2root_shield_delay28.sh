...
while IFS= read -r InFile; do
    ...
    HitFile="/home/yousen/Documents/NDLAr2x2/tred/tests/playground/for_batch_pgun/${HitFileDir}/pgun_mu_3GeV_2mm_shield_delay28.npz"
    HODir=$(dirname ${HitFile})
    HOFile="${HODir}/pgun_mu_3GeV_2mm_shield_delay28_hits.hdf5"
    ...
    HOFileSelected="${HODir}/pgun_mu_3GeV_2mm_shield_delay28_20250912_selected_hits.hdf5"
    ...
    uv run ../filter_data.py $HOFileSelected ${HODir}/pgun_mu_3GeV_2mm_shield_delay28_20250912_selected_hits.root
    uv run ../filter_data.py $QOFileSelected ${QODir}/pgun_mu_3GeV_2mm_shield_delay28_20250912_selected_effq.root
