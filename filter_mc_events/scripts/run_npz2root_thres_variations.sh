...
for thres_variation in "up0p1" "up0p2" "down0p1" "down0p2"; do
    echo "Threshold setting: $thres_variation"
    while IFS= read -r InFile; do
        ...
        HitFile="/home/yousen/Documents/NDLAr2x2/tred/tests/playground/for_batch_pgun/${HitFileDir}/pgun_thres_${thres_variation}_mu_3GeV_2mm.npz"
        HODir=$(dirname ${HitFile})
        HOFile="${HODir}/pgun_thres_${thres_variation}_mu_3GeV_2mm_hits.hdf5"
        ...
        HOFileSelected="${HODir}/pgun_thres_${thres_variation}_mu_3GeV_2mm_20250908_selected_hits.hdf5"
        ...
        uv run ../filter_data.py $HOFileSelected ${HODir}/pgun_thres_${thres_variation}_mu_3GeV_2mm_20250912_selected_hits.root
        uv run ../filter_data.py $QOFileSelected ${QODir}/pgun_thres_${thres_variation}_mu_3GeV_2mm_20250912_selected_effq.root
