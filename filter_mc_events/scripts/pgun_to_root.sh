...
# edit 20250805;
HitInFile="../pgun_mu_20250805/pgun_mu_3GeV_2mm_20250805_filtered_hits.hdf5"
...
# edit 20250805
SrcFile="${HitInFile/_hits.hdf5/_hits_source.hdf5}"
uv run ../filter_data.py $SrcFile ../pgun_mu_20250805/track_data.root
