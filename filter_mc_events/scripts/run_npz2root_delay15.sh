...
while IFS= read -r InFile; do
    ...
    HOFileSelected="${HODir}/pgun_mu_3GeV_2mm_20250908_selected_hits.hdf5"
    ...
    uv run ../filter_data.py $HOFileSelected ${HODir}/pgun_mu_3GeV_2mm_20250908_selected_hits.root
    uv run ../filter_data.py $QOFileSelected ${QODir}/pgun_mu_3GeV_2mm_20250908_selected_effq.root
