...
def prep_per_event(hits, itpc=None, highq_thres=None, check_dir=True):
    ...
    print(check_dir, 'exetended', len(extended_hits))
...
with uproot.recreate(f'{fdir}/{fprefix}.root') as f:
    ...
    hits_path = finpath.replace("effq", "hits")
    ...
    for ie in range(len(groups)):
        for itpc in range(70):
            ...
            print(extended_effq['event_id'][0], max_dist)
